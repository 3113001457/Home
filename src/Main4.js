            ...
            <div className="Main4" id="main4">
                <div className="zyh-mai zyh-maiFourth">
                    <div className="zyh-maiIn">
                        <div className="zyh-left zyh-maiLeftText">
                            <div className="zyh-textRTran">
                            <div className=" zyh-textR zyh-MaL" id="Fourthleft">
                                <div className="zyh-Rtitle"><span className="zyh-RTSpan">全面的搜索引擎优化 轻松获得更高排名</span></div>
                                <div className="zyh-RtitleB"><span className="zyh-RTBSpan">谁说自助建站的SEO效果就一定差？
                                    无需额外设置，平台自动为您生成网站地图（sitemap），帮助搜索引擎全面地对网站进行索引；同时，页面标题、页面描述以及静态化链接技术也可以帮助您更加轻松地获得较高的关键词排名。</span>
                                </div>
                            </div>
                            </div>
                        </div>
                        <div className="zyh-maiRightPic">
                            <div className=" zyh-MaL" id="Fourthright">
