                ...
                <div className="zyh-mai zyh-maiSecond">
                    <div className="zyh-maiIn">
                        <div className="zyh-left zyh-maiLeftText">
                            ...
                            <div className=" zyh-textR zyh-MaL" id="Secondleft">
                                <div className="zyh-Rtitle"><span className="zyh-RTSpan">真正的响应式自助建站，自适应所有设备</span></div>
                                <div className="zyh-RtitleB">
                                    <span className="zyh-RTBSpan">不同于其它假响应式品牌，起飞页采用的是真正的响应式引擎。您只需对网站资料进行一次性输入，网站即可根据访问者的设备智能地呈现出最佳效果，全程无需人工干预。设备包括但不限于：计算机、Pad、微信、手机和电视。</span>
                                </div>
                            </div>
                            </div>
                        </div>
